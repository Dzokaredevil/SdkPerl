...
#
package WWW::MarketcheckCarsApi::ApiClient;
...
use WWW::MarketcheckCarsApi::Configuration;
...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'WWW::MarketcheckCarsApi::Configuration' ) {
        $config = $_[0];
    } else {
        $config = WWW::MarketcheckCarsApi::Configuration->new(@_);
    }
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("WWW::MarketcheckCarsApi::Object::$class")->new;
        if (ref $data eq "HASH") {
