...
#
package WWW::MarketcheckCarsApi::Role;
use utf8;
...
has api_factory => ( is => 'ro',
                     isa => 'WWW::MarketcheckCarsApi::ApiFactory',
                     builder => '_build_af',
                     lazy => 1,
...
has _cfg => ( is => 'ro',
              isa => 'WWW::MarketcheckCarsApi::Configuration',
              default => sub { WWW::MarketcheckCarsApi::Configuration->new() },
              );
...
sub _build_af {
	...
	return WWW::MarketcheckCarsApi::ApiFactory->new(%args);
}
