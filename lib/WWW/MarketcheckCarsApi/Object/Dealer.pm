...
#
package WWW::MarketcheckCarsApi::Object::Dealer;
...
__PACKAGE__->method_documentation({
    ...
    'franchise_id' => {
    	datatype => 'string',
    	base_name => 'franchise_id',
    	description => 'Dealer franchise id',
    	format => '',
    	read_only => '',
    		},
    'name' => {
    ...
    'target_url_new' => {
    	datatype => 'string',
    	base_name => 'target_url_new',
    	description => 'Target url for the new cars listing',
    	format => '',
    	read_only => '',
    		},
    'target_url_used' => {
    	datatype => 'string',
    	base_name => 'target_url_used',
    	description => 'Target url for the used cars listing',
    	format => '',
    	read_only => '',
    		},
    'target_url_certified' => {
    	datatype => 'string',
    	base_name => 'target_url_certified',
    	description => 'Target url for the certified cars listing',
    	format => '',
    	read_only => '',
    		},
    'dealer_type' => {
    	datatype => 'string',
    	base_name => 'dealer_type',
    	description => 'Dealer type - independent, franchise, multi-brand, authorized',
    	format => '',
    	read_only => '',
    		},
    'rating' => {
